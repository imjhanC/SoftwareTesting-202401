...
public class FSMWatchTest {
	...
	@Test
	@Parameters({ "pressSet,setHrs,Showing Set Hrs,5,10,6,10", "pressSet,setHrs,Showing Set Hrs,23,10,0,10",
	...
	@Test
	@Parameters({ "pressSet,setMins,Showing Set Mins,5,10,5,11", "pressSet,setMins,Showing Set Mins,5,59,5,00",
